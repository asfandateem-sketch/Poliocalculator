...
export const PLATFORM_CATEGORIES: PlatformCategory[] = [
  ...
  {
    key: 'videos',
    labelEn: 'Communication Resources',
    labelUr: 'مواصلاتی وسائل',
    shortLabelEn: 'Communication Resources',
    shortLabelUr: 'مواصلاتی وسائل',
    icon: FileVideo,
    isAvailable: true,
    itemCount: 5,
  },
  ...
  },
  {
    ...
    shortLabelEn: 'FAQs',
    shortLabelUr: 'اکثر پوچھے گئے سوالات',
    icon: AlertCircle,
    isAvailable: true,
    itemCount: 5,
  },
