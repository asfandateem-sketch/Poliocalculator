...
export const SEARCHABLE_ITEMS: SearchableItem[] = [
  ...
  // ================= COMMUNICATION RESOURCES & VIDEO FOLDERS (High Intent) =================
  {
    ...
    badgeUr: 'طبی و اطفال',
    keywords: ['healthcare', 'health care', 'pediatrician', 'doctor', 'medical', 'fever', 'safety', 'halth care', 'ہیلتھ کیئر', 'ڈاکٹر', 'طبی', 'اطفال', 'بخار'],
    targetAnchor: 'videos',
    highlightTextEn: 'Pediatric masterclasses & clinical statements from health care professionals',
    highlightTextUr: 'ماہرین اطفال کے مستند بیانات اور کلینیکل پیغامات',
  },
  {
    id: 'vid-folder-comm',
    category: 'videos',
  ...
  },
  {
    ...
    keywords: ['religious', 'ulema', 'fatwa', 'halal', 'islamic', 'cii', 'مذہبی', 'علماء', 'فتویٰ', 'حلال', 'شریعت'],
    targetAnchor: 'videos',
    highlightTextEn: 'Religious Influencers Videos and Shariah endorsements',
    highlightTextUr: 'علمائے کرام و مذہبی رہنما ویڈیوز اور شرعی توثیقات',
  },
  {
    id: 'vid-folder-pol',
    category: 'videos',
  ...
  },
  {
    ...
    category: 'videos',
    type: 'video',
    typeLabelEn: 'Resource Library',
    typeLabelUr: 'مواصلاتی لائبریری',
    titleEn: 'Communication Resources Hub',
    titleUr: 'کمیونیکیشن ریسورسز حب',
    descriptionEn: 'Access official field communication resources (Healthcare, Community, Religious, and operational guides) directly within Polio Field Tools.',
    descriptionUr: 'مستند مواصلاتی مواد اور فیلڈ گائیڈز (ہیلتھ کیئر، مذہبی، دیگر) کو ایپ میں براؤز کریں۔',
    badgeEn: 'Official Repository',
    badgeUr: 'مستند مواد',
    keywords: ['resources', 'videos', 'documents', 'library', 'مواد', 'ویڈیوز', 'لائبریری'],
    targetAnchor: 'videos',
  },
