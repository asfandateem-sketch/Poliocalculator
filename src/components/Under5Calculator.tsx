          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onKeyDown={(e) => e.key === 'Enter' && calculate()}
                className="h-9 w-full pl-3 pr-7 text-xs font-mono bg-slate-50/80 border border-slate-200/90 rounded-xl focus:bg-white focus:outline-hidden focus:ring-2 focus:ring-teal-500/20 focus:border-teal-600 transition shadow-2xs font-medium text-slate-900 placeholder:text-slate-400"
              />
