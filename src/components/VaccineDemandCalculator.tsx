      ...
      <div>
        <div className="pb-3 border-b border-slate-100 mb-3.5">
          <div className="flex items-center justify-between gap-2.5">
            ...
            <span className="text-[11px] sm:text-xs font-mono font-semibold text-teal-800 bg-teal-50 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-md border border-teal-200/70 flex-shrink-0" dir="ltr">
              {strings.badge}
            </span>
          </div>
